...
public class Yves extends Thread {
    ...
    public Yves(int id, Socket client) {
        try {
            ...
            // envoie de son identifiant au joueur
            out.println("Id=" + id);
    ...
    public void run() {
        try {
            ...
            // attend qu'il y ait au moins 3 joueur avant de démarrer
            while (nbr_id < 3) {
            }
    ...
    private int[] draw(int nb_dice) {
        // initalisation du random et de la main
    ...
    private void tour() {
        ...
        // information de à qui est le tou
        ...
        if (joueur_actif == id) {
            ...
            while (!action_valide) {
                ...
                try {
                    ...
                    // vérification de si c'est un bluff
                    ...
                    // si ce n'est pas un bluff
                        ...
                        // transforme l'input en inforation processable
            ...
            if (!Bluff) {
                ...
                //informe les joueur que le joueur actif à dit bluff
                try {
                    for (int i = 0; i < nbr_id; i++) {
                ...
                // compte le nombre d'itération dans la poll totale
                ...
                // informe les joueur du résultat
                    for (int i = 0; i < nbr_id; i++) {
        ...
        //si le joueur n'est pas acitf, stand by and read
